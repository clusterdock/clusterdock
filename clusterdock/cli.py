...
def main():
    ...
    start_parser.add_argument('-c', '--cluster-name',
                              ...
                              metavar='name')
    start_parser.add_argument('--clusterdock-config-directory',
                              help='Directory where files generated by clusterdock are available',
                              default=defaults['DEFAULT_CLUSTERDOCK_CONFIG_DIRECTORY'],
                              metavar='confdir')
    ...
    if hasattr(args, 'topology'):
        ...
        clusterdock_config_directory = os.path.expanduser(args.clusterdock_config_directory)
        logger.info('clusterdock_config_directory = %s', clusterdock_config_directory)
